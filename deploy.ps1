# Zerion GCP Deployment Script
# Run this from the project root: C:\Users\chris\Projects\agent-accounting
#
# Prerequisites:
#   - gcloud CLI installed and authenticated
#   - Docker Desktop running (or use deploy-cloudbuild.ps1 instead)
#   - Terraform installed
...
if (-not $docker) { throw "Docker not found. Install Docker Desktop or use deploy-cloudbuild.ps1 instead." }
...
Write-Host "[4/6] Building and pushing container image..." -ForegroundColor Yellow
